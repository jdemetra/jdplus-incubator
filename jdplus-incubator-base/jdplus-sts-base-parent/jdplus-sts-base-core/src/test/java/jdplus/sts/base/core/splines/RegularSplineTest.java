...
public class RegularSplineTest {
    ...
    public void testInt() {
        ...
        for (int i = 0; i < 100000; ++i) {
            ...
            for (int j = 0; j < nc; ++j) {
                assertEquals(rs.cycleFor(observations.pos(j)), i);
            }
            n += nc;
        }
        assertEquals(2500000, n);
    }
