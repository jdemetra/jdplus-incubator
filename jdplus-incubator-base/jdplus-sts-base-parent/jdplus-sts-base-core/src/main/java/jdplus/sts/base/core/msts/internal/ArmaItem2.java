 ...
 * @author palatej
 */
public class ArmaItem2 extends StateItem {

    private final StablePolynomialInterpreter par, pma;
    private final VarianceInterpreter v;

    public ArmaItem2(final String name, double[] ar, boolean fixedar, double[] ma, boolean fixedma, double var, boolean fixedvar) {
        super(name);
    ...
    private ArmaItem2(ArmaItem2 item) {
        super(item.name);
    ...
    @Override
    public ArmaItem2 duplicate() {
        return new ArmaItem2(this);
    }
    ...
    public void addTo(MstsMapping mapping) {
        ...
        mapping.add((p, builder) -> {
            ...
            builder.add(name, cmp, SsfArma2.defaultLoading());
            return pos;
        });
    }
