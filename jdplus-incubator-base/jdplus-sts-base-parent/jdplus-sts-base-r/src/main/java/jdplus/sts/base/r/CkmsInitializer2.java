...
/**
 * Workaround a bug in 3.7.1
 * Should be suppressed in 3.7.2
 * @author Jean Palate
 */
@Development(status = Development.Status.Alpha)
public class CkmsInitializer2 implements CkmsFilter.IFastFilterInitializer {
