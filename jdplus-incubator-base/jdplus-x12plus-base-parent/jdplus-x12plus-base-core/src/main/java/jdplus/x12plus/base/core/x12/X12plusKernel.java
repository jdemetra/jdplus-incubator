...
import jdplus.x12plus.base.core.X11plusKernel;
import jdplus.x12plus.base.core.X11plusResults;

@lombok.Value
public class X12plusKernel {

    private static PreliminaryChecks.Tool of(X12plusSpec spec) {
    ...
    public static X12plusKernel of(X12plusSpec spec, ModellingContext context) {
    ...
    public X12plusResults process(TsData s, ProcessingLog log) {
        ...
        try {
            ...
            if (preprocessor != null) {
                ...
                preprocessing = null;
                preadjustment = X12plusPreadjustment.builder().a1(sc).build();
                alin = sc;
            }
            // Step 3. X11
            ...
            X12plusFinals finals = finals(nspec.getMode(), preadjustment, xr);
            ...
            return X12plusResults.builder()
                    ...
                    .finals(finals)
                    .benchmarking(bench)
                    .diagnostics(X12plusDiagnostics.of(preprocessing, preadjustment, xr, finals))
                    .log(log)
                    .build();
        } catch (Exception err) {
            log.error(err);
...
//                SaBenchmarkingResults bench = null;
//                // Step 6. Diagnostics
//                X12plusDiagnostics diagnostics = X12plusDiagnostics.of(null, rslt, rslt.asDecomposition());
//
//                return X12plusResults.builder()
//                        .preprocessing(null)
//                        .decomposition(rslt)
...
//                }
//                // Step 6. Diagnostics
//                X12plusDiagnostics diagnostics = X12plusDiagnostics.of(preprocessing, rslt, finals);
//
//                return X12plusResults.builder()
//                        .preprocessing(preprocessing)
//                        .decomposition(rslt)
...
//        }
    ...
    private TsData initialStep(RegSarimaModel model, int nb, int nf, X12plusPreadjustment.Builder astep) {
    ...
    private X12plusFinals finals(DecompositionMode mode, X12plusPreadjustment astep, X11plusResults x11) {
        // add preadjustment
        ...
        X12plusFinals.Builder decomp = X12plusFinals.builder();
