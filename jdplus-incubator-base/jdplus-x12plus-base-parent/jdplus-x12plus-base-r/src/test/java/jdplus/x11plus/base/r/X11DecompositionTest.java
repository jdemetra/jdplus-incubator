 ...
 */
import jdplus.x12plus.base.r.X11Decomposition;
...
public class X11DecompositionTest {
    ...
    public void testX11() {
        ...
        X11Decomposition.Results r1 = X11Decomposition.cnX11(s, 12, true, 11, 2, "Henderson", 3, "Epanechnikov", 1.5, 2.5);
        assertNotSame(r1, null);
