...
public class HighFreqDefinition {
    ...
    public static class Builder {
        ...
        public HighFreqDefinition build() {
            if (estimationSpec == null) {
                estimationSpec = domainSpec;
            } 
            return new HighFreqDefinition(domainSpec, estimationSpec, policy, ts);
        }
    }
