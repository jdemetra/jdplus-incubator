...
public class LighExtendedAirlineDecompositionExtractor extends InformationMapping<LightExtendedAirlineDecomposition> {
    ...
    public LighExtendedAirlineDecompositionExtractor() {
