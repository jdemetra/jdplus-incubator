...
public class X13plusSpec implements SaSpecification{
    ...
    public static final X13plusSpec FULL=X13plusSpec.builder()
            .preprocessing(ModellingSpec.FULL)
            .x11(null)
            .benchmarking(SaBenchmarkingSpec.DEFAULT_DISABLED)
            .build();
    
    public static final X13plusSpec DEFAULT=X13plusSpec.builder()
