...
public class LtdDecompositionException extends SaException {
     ...
     *
     */
    public LtdDecompositionException() {
    }
     ...
     * @param msg
     */
    public LtdDecompositionException(String msg) {
	super(msg);
    }
     ...
     */
    public LtdDecompositionException(final String message, final Exception innerException) {
