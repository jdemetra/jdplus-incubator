...
public class Actions {
    ...
    @ActionReferences({
        @ActionReference(path = ExtendedAirlineDocumentManager.ITEMPATH, position = 1050),
        @ActionReference(path = ExtendedAirlineDecompositionDocumentManager.ITEMPATH, position = 1050)
    })
    ...
    @ActionReferences({
        @ActionReference(path = ExtendedAirlineDocumentManager.ITEMPATH, position = 1150),
        @ActionReference(path = ExtendedAirlineDecompositionDocumentManager.ITEMPATH, position = 1150)
    })
    ...
    @ActionReferences({
        @ActionReference(path = ExtendedAirlineDocumentManager.ITEMPATH, position = 1100),
        @ActionReference(path = ExtendedAirlineDecompositionDocumentManager.ITEMPATH, position = 1100)
    })
    ...
    @ActionReferences({
        @ActionReference(path = ExtendedAirlineDocumentManager.PATH, position = 1000),
        @ActionReference(path = ExtendedAirlineDecompositionDocumentManager.PATH, position = 1000)
    })
